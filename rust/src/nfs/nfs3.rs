...
fn test_rpc_stream_req1() {
    ...
    let mut p = NFS3State::new();
    let mut res = NFS3State::parse_tcp_data_ts(&mut p, &bytes_a);
    assert_eq!(res, 0);
    res = NFS3State::parse_tcp_data_ts(&mut p, &bytes_b);
    assert_eq!(res, 0);
...
fn test_rpc_stream_req2() {
    ...
    assert_eq!(actual_xid, expected);
    res = NFS3State::parse_tcp_data_ts(&mut p, &bytes_c);
    assert_eq!(res, 0);
    expected = 0x7507f077;
